...
![Алгоритм системы инициализации станка](img/odna_storona.png "Алгоритм  системы инициализации станка")
...
![Алгоритм работы системы идентификации заготовки печатной платы](img/algortim.png "Алгоритм работы системы идентификации заготовки печатной платы")
