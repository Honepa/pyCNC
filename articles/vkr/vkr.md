...
В этой главе было подготовленно и согласовано с руководителем (Приложение не знаю какое) техническое задание к проекту, согласно которому была разработана и протестированна аппаратная часть станка. 
...
![устройство в сборе](img/ves_algo.svg "устройство в сборе")

Рисунок . Общий алгоритм работы системы

Алгоритм инициализации станка
![Алгоритм инициализации станка](img/inti_algo.svg "Алгоритм инициализации станка")

Рисунок . Алгоритм инициализации станка
...
Алгоритм преобразования схемы в набор команд
![Алгоритм преобразования схемы в набор команд](img/preobr_algo.svg "Алгоритм преобразования схемы в набор команд")

Рисунок . Алгоритм преобразования схемы в набор команд
