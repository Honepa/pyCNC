...
Ну кароче, включили, оно поехало, сломалось, загорелось, уехало, крыша съехала писать этот диплом, спать хочется и кушать, а так норм, система работатет.
...
Алгоритм системы преобразования схемы в набор команд.
