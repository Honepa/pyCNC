...
Для успешного определения контуров, необходимо на рисунке схемы закрасить все отверстия под компоненты (Листинг какой-то).

Листинг . Код закрашивания отверстий под компоненты на схеме печатной платы и определения контуров фрезирования.
```python
