...
Выпускная квалификационная работа 4 главы, 82 стр., 24 рисунка, 1 таблица, 31 источник, 9 приложений.

Ключевые слова: ИНТЕГРАЦИЯ, ИНФОРМАЦИОННАЯ СИСТЕМА, БИЗНЕС-ПРОЦЕСС, СТРУКТУРА, СУБД, ФУНКЦИОНАЛЬНАЯ МОДЕЛЬ, API, ODBC.

Объектом исследования в рамках данной диссертационной работы является процесс интеграции программного комплекса фигурного раскроя листового материала с информационной системой предприятия.

Цель работы: разработка методики интеграции программного комплекса фигурного раскроя листового материала с информационной системой предприятия.

В процессе работы использовались методы сравнения и моделирования.

В результате диссертационного исследования был исследован бизнес-процесс интеграции программного комплекса фигурного раскроя листового материала и информационной системы предприятия, разработаны функциональные модели бизнес-процесса интеграции систем в разрезе «КАК ЕСТЬ» и «КАК ДОЛЖНО БЫТЬ», процедура интеграции данных, практические рекомендации к бизнес-процессу интеграции информационных систем. 

Практическая значимость работы заключается в получении механизма интеграции разработанного программного комплекса фигурного раскроя листового материала с информационными системами предприятия.

Разработанные рекомендации могут быть применены при проектировании и разработке программных модулей, необходимых для внедрения комплекса в корпоративную информационную систему ОАО «ПЗМ».
